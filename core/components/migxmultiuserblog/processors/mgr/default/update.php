...
if ($checkresponse) {
    ...
    if ($scriptProperties['object_id'] == 'new' && $parent_o = $modx->getObject('ArticlesContainer',$parent)){
        $object['preview_url'] = $this->modx->makeUrl($parent_o->get('id'), $parent_o->get('context_key'), '', 'full');    
    }
